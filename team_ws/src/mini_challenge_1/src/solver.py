...
class Solver:
    ...
    def main(self):
        while not rospy.is_shutdown():
            if self.puzzlebot_vel_on_base_frame_x is not None and self.puzzlebot_vel_on_base_frame_y is not None and self.puzzlebot_vel_on_base_frame_th is not None:
